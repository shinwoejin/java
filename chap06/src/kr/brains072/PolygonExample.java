...
public class PolygonExample {
	// 매개변수에 배열을 사용하면 매개변수 개수를 가변적으로 사용할 수 있다.
	public static void main(String[] args) {
		// Polygon 형의 poly라는 참조변수를 사용
		// Triangle, Square, Trapezoid .. 상속받음, 공통적인 특직을 가짐
		ArrayList<Polygon> arrPoly = new ArrayList<>();
		// ArrayList<>();안에 형태에 관계없이 보관하기위해 <> 안에 
		...
		sRef = (String) o; //error 형변환은 됬지만 원하는 형태는 되지 않음.
		sRef.substring(3);
		}
	}
